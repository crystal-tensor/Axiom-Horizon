...
| B10 | Boundary of BQP | T-B10-010 missing-assumption theorem note: 2 theorem skeletons, 5 missing assumptions, 5 proof obligations, source route count 4, B3 demoted true, B5 positive-ready false, and no dequantization theorem, sampling-access theorem, BQP separation, or quantum advantage claim. B10-T2 still has the trained-spoofer/proof-gate/transcript/device-noise/Qiskit-Aer/backend-calibrated-style bridge stack. | T-B10-011 must define an asymptotic B3/B5 observable family and equivalent explicit/oracle/sampling-access contracts, then prove or refute the sampling-access bridge; separately, replace the GenericBackendV2 bridge with real backend properties or hardware verifier execution. | Keep B10 as a negative-boundary/theorem-target track if T-B10-011 cannot define equivalent access contracts or a proof-checkable theorem target. |
