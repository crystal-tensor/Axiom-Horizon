...
Current state: **stage 1i evidence hardening; B10-T1 B5 same-access sampling-or-DMRG bridge is complete, and the next theory gate is production DMRG/MPS or a fully costed response sampler**.
