...
Current state: **stage 1u evidence hardening; B2 now has a hardware-like leakage observation model gate but it remains a negative boundary, B5 has a canonical DMRG readiness gate, B6 has a structural/electronic proxy boundary, and B10 remains a denominator-boundary track**.
