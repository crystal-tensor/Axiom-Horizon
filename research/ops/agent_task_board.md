...
| T-B2-004 | B2 | open | unassigned | Builder/Baseline Adversary | Replace the analytic leakage-flagged erasure proxy with a circuit-level leakage/erasure decoder experiment or calibrated leakage model; preserve distance-5/7 Wilson target-volume reductions under noise mismatch, measure decoder/runtime overhead and flag false-positive cost, or demote the proxy. |
