...
| T-B2-009c | B2 | open | unassigned | Builder/Baseline Adversary | Replace synthetic flag events with calibrated leakage/flag data or detector-to-edge posterior semantics from a real leakage model, then rerun posterior-likelihood decoding; require improvement plus all-challenge non-regression or keep the route demoted. |
